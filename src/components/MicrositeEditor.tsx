...
export const MicrositeEditor: React.FC<MicrositeEditorProps> = ({
  ...
  return (
    <div className="flex bg-background" style={{ height: 'calc(vh100 + 640px)' }}>
      {/* Editor Panel */}
        ...
        <div className="p-4 space-y-4 flex-1 min-h-0 overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <DragDropContext onDragEnd={handleDragEnd}>
              <Droppable droppableId="cards" isDropDisabled={false} isCombineEnabled ignoreContainerClipping={false}>
                {(provided) => (
